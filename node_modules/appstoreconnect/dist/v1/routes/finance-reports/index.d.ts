 ...
 * @param query
 */
export declare function downloadFinancialReports(api: API, query: GetFinanceReportsQuery): Promise<Buffer>;
/**
 * Download sales and trends reports filtered by your specified criteria.
 * @param query
 */
export declare function downloadSalesReports(api: API, query: GetSalesReportsQuery): Promise<Buffer>;
...
declare type SalesReportType = 'SALES' | 'PRE_ORDER' | 'NEWSSTAND' | 'SUBSCRIPTION' | 'SUBSCRIPTION_EVENT' | 'SUBSCRIBER';
export {};
